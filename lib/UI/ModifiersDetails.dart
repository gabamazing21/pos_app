...
ModifiersDetails(this.currentModifiers);

  _ModifiersDetailsState createState()=>_ModifiersDetailsState(currentModifiers);
}
...
_ModifiersDetailsState(this.currentModifiers);
    ...
    child: Column(
      ...
      children: [
        ...
        Container(
          ...
          child: Text("Options",style:TextStyle(fontSize: 24,color: Colors.black,fontWeight: FontWeight.bold),),
              ...
              child: Stack(
                children: [
                  Positioned(
                    top: 10,
                    left: 0,
                    child: Text("CheckBox Option",style: TextStyle(color: Colors.black,fontSize: 16,),),
                  ),
                  Positioned(
                      top: 0,
                      right: 0,
                      child: Checkbox(value: ischeckbox, onChanged: (vale){
                        setState(() {
                          ischeckbox=vale;
                        });
        ...
        Container(
          ...
          child: Text("Items", style: TextStyle(fontSize: 24,color: Colors.black,fontWeight: FontWeight.bold),),
        ),
        Container(
          width: MediaQuery.of(context).size.width,
          margin: EdgeInsets.only(top: 0,left: 20,right: 20),
        ...
        Container(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (BuildContext context,int index)=>MenuItem(foodInModifiers.elementAt(index)),),
        ...
        GestureDetector(
          ...
          child: Container(
            ...
            child: Text("Add Items",style: TextStyle(fontSize: 16,color: Colors.black.withOpacity(0.5)),),
              ...
              child: Container(
                ...
                mainAxisAlignment: MainAxisAlignment.start,
                  ...
                  children: [
                    ...
                    Container(
                      margin: EdgeInsets.only(left: 10),
                      child: Text("${item.itemName}",style: TextStyle(color: Colors.black,fontSize: 16),),
                    )
              ...
              child: Row(
                ...
                children: [
                  Container(
                    ...
                    child: Text("${utils.localcurrency(item.itemprice)}",style: TextStyle(color: Colors.black.withOpacity(0.3),fontSize: 16),),
                  ),
                  GestureDetector(
                    onTap: (){
                      setState(() {
...
void showFoodList(){
  ...
  showCupertinoDialog(context: context, builder: (BuildContext context)=>AlertDialog(title: Text("Food List"),
  content: FoodList(),
    actions: <Widget>[
      FlatButton(
        onPressed: () {
    ...
    child: ListView.separated(
      ...
      padding: EdgeInsets.all(0.0),
        ...
        itemBuilder: (BuildContext context,index)=>GestureDetector(
            ...
            child: Container(child: Text("${foodlist.elementAt(index).itemName}",style: TextStyle(fontSize: 20,color: Colors.black.withOpacity(0.6),fontWeight: FontWeight.bold),),))
    ),
...
isloading=true;
  ...
  FirebaseFirestore.instance.collection("Modifiers").add({
    ...
    "items":List.generate(foodInModifiers.length, (index) => foodInModifiers.elementAt(index).itemId)
  }).then((value) {
