...
if(currentsubmenu!=null){
  ...
  if(currentsubmenu.subMenu.isNotEmpty)
  getSubmenuList();
  getModfierList();
...
getModifierList();
                  ...
                  children: [
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Text("Add Modifiers", style: TextStyle(fontSize: 16,
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        margin: EdgeInsets.only(left: 20, top: 10),
                        child: Text("Add SubMenu", style: TextStyle(fontSize: 16,
                            color: Colors.black.withOpacity(0.5)),),
          ...
          Container(
            ...
            decoration: BoxDecoration(
                image: DecorationImage(
                  image: (_pickFile == null) ? (item == null) ? AssetImage(
                    'assets/images/placeholder.jpg',) : NetworkImage(
                      item.imagelink) : FileImage(_pickFile),
                  fit: BoxFit.cover,)
  ...
  void showModifierList(){
    ...
    showCupertinoDialog(context: context, builder: (BuildContext context)=>AlertDialog(title: Text("Modifiers List"),
  ...
  void showsubMenuList(){
    ...
    showCupertinoDialog(context: context, builder: (BuildContext context)=>AlertDialog(title: Text("SubMenu List"),
      content: SubMenuList(),
      actions: <Widget>[
        FlatButton(
          onPressed: () {
    ...
    return Container(
      ...
      child: ListView.separated(
          ...
          itemBuilder: (BuildContext context,index)=>GestureDetector(
              ...
              child: Container(child: Text("${modifierList.elementAt(index).modifier_name}",style: TextStyle(fontSize: 20,color: Colors.black.withOpacity(0.6),fontWeight: FontWeight.bold),),))
      ),
  ...
  uploadTask.then((value) {
    value.ref.getDownloadURL().then((value)async {
      ...
      FirebaseFirestore.instance.collection("subMenu").add({
        ...
        "subMenu":(subMenuInSubMenu.isEmpty)?null:List.generate(subMenuInSubMenu.length, (index) =>subMenuInSubMenu.elementAt(index).submeuid),
        "modifiers":List.generate(modifiersInSubMenu.length, (index) => modifiersInSubMenu.elementAt(index).id)});
...
Future<void> getModfierList()async{
  modifiersInSubMenu=await database.getAllModifierList(currentsubmenu.modifiers);
