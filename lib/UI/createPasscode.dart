            ...
            Container(
                ...
                child: Padding(
                    ...
                    child: PinCodeTextField(
                      ...
                      // obscureText: false,
                      controller: (!showreEnteredpin)
                          ? _pinVerificationController
                          : _reEnterPinVerificationController,
                      ...
                      if (ispinentered) {
                        if (!showreEnteredpin) {
                          setState(() {
                            ...
                            ispinentered = false;
                            firstPin = _pinVerificationController.text;
                            _reEnterPinVerificationController.clear();
                            _pinVerificationController.clear();
                          });
                        } else {
                          if (firstPin.contains(
                              _reEnterPinVerificationController.text)) {
                            FirebaseFirestore.instance
                              ...
                              tempovalueInstance.getInstance().passcode =
                                  _pinVerificationController.text;
